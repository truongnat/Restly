...
const db = {
  users: [
    ...
    { id: '4', name: 'David Brown', email: 'david@example.com', role: 'moderator', createdAt: '2024-04-05T16:20:00Z' },
    { id: '5', name: 'Eve Davis', email: 'eve@example.com', role: 'user', createdAt: '2024-05-12T11:00:00Z' },
  ],
  posts: [
    { id: '1', userId: '1', title: 'Getting Started with REST APIs', body: 'REST APIs are the backbone of modern web development...', tags: ['api', 'rest', 'tutorial'], views: 1520, createdAt: '2024-06-01T08:00:00Z' },
    { id: '2', userId: '2', title: 'Understanding HTTP Methods', body: 'GET, POST, PUT, PATCH, DELETE - each has its purpose...', tags: ['http', 'methods'], views: 890, createdAt: '2024-06-05T12:30:00Z' },
    { id: '3', userId: '1', title: 'Authentication Best Practices', body: 'Securing your API with proper authentication...', tags: ['security', 'auth', 'jwt'], views: 2340, createdAt: '2024-06-10T15:45:00Z' },
    { id: '4', userId: '3', title: 'Error Handling in APIs', body: 'Proper error responses make debugging easier...', tags: ['errors', 'best-practices'], views: 670, createdAt: '2024-06-15T09:20:00Z' },
    { id: '5', userId: '4', title: 'Pagination Strategies', body: 'Offset vs cursor-based pagination compared...', tags: ['pagination', 'performance'], views: 1100, createdAt: '2024-06-20T14:10:00Z' },
  ],
  comments: [
    { id: '1', postId: '1', userId: '2', body: 'Great introduction!', createdAt: '2024-06-02T10:00:00Z' },
    { id: '2', postId: '1', userId: '3', body: 'Very helpful, thanks!', createdAt: '2024-06-02T11:30:00Z' },
    { id: '3', postId: '3', userId: '4', body: 'Security is so important.', createdAt: '2024-06-11T08:15:00Z' },
  ],
...
app.get('/api/docs', (req, res) => {
  res.json({
    ...
    paths: {
      ...
      '/api/users/{id}': { get: { summary: 'Get user' }, put: { summary: 'Update user' }, delete: { summary: 'Delete user' } },
...
app.get('/api/auth/apikey', (req, res) => {
  ...
  if (!apiKey) {
    return res.status(401).json({ error: 'API key required', hint: 'Use X-API-Key header or ?apiKey= query param' });
  }
...
app.get('/api/debug/content-type/:type', (req, res) => {
  ...
  switch (type) {
    case 'json':
      ...
      break;
    case 'xml':
      res.type('application/xml').send('<?xml version="1.0"?><response><format>xml</format><status>ok</status></response>');
      break;
    case 'html':
      res.type('text/html').send('<html><body><h1>HTML Response</h1><p>This is HTML content.</p></body></html>');
      break;
    case 'text':
    ...
    case 'yaml':
      ...
      break;
    default:
      res.status(400).json({ error: 'Unknown type', available: ['json', 'xml', 'html', 'text', 'csv', 'yaml'] });
  }
});
...
app.post('/api/files/upload', upload.single('file'), (req, res) => {
  if (!req.file) {
    return res.status(400).json({ error: 'No file uploaded', hint: 'Use form-data with field name "file"' });
  }
...
app.get('/api/files/download/:type', (req, res) => {
  ...
  const files = {
    json: { name: 'sample.json', content: JSON.stringify({ sample: true }, null, 2), mime: 'application/json' },
    text: { name: 'sample.txt', content: 'This is a sample text file.\nLine 2\nLine 3', mime: 'text/plain' },
    csv: { name: 'sample.csv', content: 'id,name,value\n1,Item A,100\n2,Item B,200', mime: 'text/csv' },
  };
